...
bench_backend!(blend_multiply_cairo, backend_cairo, BLEND_MULTIPLY_SVG);
bench_backend!(blend_multiply_qt, backend_qt, BLEND_MULTIPLY_SVG);
bench_backend!(blend_multiply_raqote, backend_raqote, BLEND_MULTIPLY_SVG);
...
bench_backend!(composite_over_cairo, backend_cairo, COMPOSITE_OVER_SVG);
bench_backend!(composite_over_qt, backend_qt, COMPOSITE_OVER_SVG);
bench_backend!(composite_over_raqote, backend_raqote, COMPOSITE_OVER_SVG);
bench_backend!(composite_over_skia, backend_skia, COMPOSITE_OVER_SVG);
...
bench_backend!(color_matrix_cairo, backend_cairo, COLOR_MATRIX_SVG);
bench_backend!(color_matrix_qt, backend_qt, COLOR_MATRIX_SVG);
bench_backend!(color_matrix_raqote, backend_raqote, COLOR_MATRIX_SVG);
bench_backend!(color_matrix_skia, backend_skia, COLOR_MATRIX_SVG);
...
bencher::benchmark_main!(blend, blur, composite, color_matrix);
