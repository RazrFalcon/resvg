...
bench_backend!(
    stroke_cairo,
    backend_cairo,
    BASE_SVG.replace("#style#", "fill='none' stroke='black'")
);
bench_backend!(
    stroke_qt,
    backend_qt,
...
bench_backend!(
    fill_cairo,
    backend_cairo,
    BASE_SVG.replace("#style#", "fill='black'")
);
bench_backend!(
    fill_qt,
    backend_qt,
...
bench_backend!(
    ...
    backend_cairo,
    BASE_SVG.replace("#style#", "fill='green' stroke='black'")
);
bench_backend!(
    fill_and_stroke_qt,
    backend_qt,
...
bench_backend!(
    ...
    BASE_SVG.replace(
        "#style#",
        "fill='none' stroke='black' stroke-dasharray='2 4 6'"
    )
);
bench_backend!(
    dashed_stroke_qt,
