...
#[test] fn fframes_image_ff_image_no_height() { assert_eq!(render("tests/fframes/image/ff_image_no_height"), 0); }
#[test] fn fframes_image_ff_image_no_width() { assert_eq!(render("tests/fframes/image/ff_image_no_width"), 0); }
#[test] fn fframes_image_ff_image_scaled_width() { assert_eq!(render("tests/fframes/image/ff_image_scaled_width"), 0); }
#[test] fn fframes_transform_origin_ff_transform_origin_all() { assert_eq!(render("tests/fframes/transform_origin/ff_transform_origin_all"), 0); }
#[test] fn fframes_transform_origin_ff_transform_origin_image() { assert_eq!(render("tests/fframes/transform_origin/ff_transform_origin_image"), 0); }
#[test] fn fframes_transform_origin_ff_transform_origin_rotate() { assert_eq!(render("tests/fframes/transform_origin/ff_transform_origin_rotate"), 0); }
#[test] fn fframes_transform_origin_ff_transform_origin_skew() { assert_eq!(render("tests/fframes/transform_origin/ff_transform_origin_skew"), 0); }
#[test] fn fframes_transform_origin_ff_transform_origin_text() { assert_eq!(render("tests/fframes/transform_origin/ff_transform_origin_text"), 0); }
#[test] fn fframes_transform_origin_ff_transform_origin_text_units() { assert_eq!(render("tests/fframes/transform_origin/ff_transform_origin_text_units"), 0); }
